[![Open in MATLAB Online](https://www.mathworks.com/images/responsive/global/open-in-matlab-online.svg)](https://matlab.mathworks.com/open/github/v1?repo=DrPaulValle/ProyectoGD)

# Proyecto: Metabolismo Celular

## Información de las estudiantes
María Belén Galindo Ramírez \[22211755]; 122211755@tectijuana.edu.mx
Ana Kamila Valle Z. Flores \[22211769]; 122211769@tectijuana.edu.mx
...
Desarrollar y analizar un gemelo digital que emule la dinámica de una reacción metabólica celular. El metabolismo celular representa la red compleja de reacciones bioquímicas que permiten a la célula transformar nutrientes en energía y componentes estructurales. En este proyecto, el proceso se centra en la cinética enzimática, donde una enzima facilita la conversión de un sustrato en un producto final indispensable para las funciones celulares.

El sistema se formula mediante ecuaciones diferenciales ordinarias que involucran tres variables de estado principales:
* **x(t):** Concentración del complejo Enzima-Sustrato.
* **y(t):** Concentración del Producto Final.
* **z(t):** Concentración del Sustrato disponible.
...
1. Procesamiento y normalización de datos experimentales asociados al metabolismo celular y cálculo de sus bioestadísticos.
2. Aplicación de regresión simbólica mediante el software Eureqa para la deducción y obtención de las ecuaciones diferenciales del modelo matemático no lineal.
...
5. Construcción del diagrama de bloques en Simulink para integrar las ecuaciones diferenciales del sistema en lazo cerrado.
...
1. Scripts y cuaderno computacional de MATLAB [.m / .mlx].
2. Modelo del gemelo digital en Simulink [.slx].
3. Reporte técnico y análisis matemático exhaustivo del sistema [.pdf].
4. Imágenes de las simulaciones y gráficas resultantes [.png / .pdf].

## Referencias
\[1] P. A. Valle, Syllabus para Gemelos Digitales, Tecnológico Nacional de México / Instituto Tecnológico de Tijuana, Tijuana, B.C., México, 2026. Permalink: https://biomath.xyz/course/
